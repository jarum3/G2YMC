...
# TODO: Convert these to little-endian representations
# Convert memory address to binary (Big-endian)
def addrToBinary(num: int) -> str:
    return f"{num:b}"[-16:].zfill(16) # Convert to binary, trim last 16 bits, zero fill to 16

# Convert binary number to address (Big-endian)
